...
(function(a) {
  ...
  a.extend(m.prototype, {
    ...
    _cachePositions: function() {
      ...
      b = a.map(n, function(b, e) {
        return n.length < e - 1
          ? (b + n[e + 1]) / 2
          : (b + b + a(c.row(":last-child").node()).outerHeight()) / 2;
      });
      this.s.middles = b;
    ...
    _clonePosition: function(a) {
      ...
      0 > b
        ? (b = 0)
        : b + this.s.domCloneOuterHeight > this.s.documentOuterHeight &&
          (b = this.s.documentOuterHeight - this.s.domCloneOuterHeight);
    ...
    _eventToPage: function(a, e) {
      return -1 !== a.type.indexOf("touch")
        ? a.originalEvent.touches[0]["page" + e]
        : a["page" + e];
    },
    _mouseDown: function(c, e) {
      ...
      a(d)
        .on("mouseup.rowReorder touchend.rowReorder", function(a) {
          b._mouseUp(a);
        })
    ...
    _mouseMove: function(c) {
      this._clonePosition(c);
      for (
        var e = this._eventToPage(c, "Y") - this.s.bodyTop,
          b = this.s.middles,
          d = null,
          f = this.s.dt,
          g = f.table().body(),
      ...
      if (null === this.s.lastInsert || this.s.lastInsert !== d)
        0 === d
          ...
          : ((e = a.unique(
            ...
            d > this.s.lastInsert
              ? this.dom.target.insertAfter(e[d - 1])
              : this.dom.target.insertBefore(e[d])),
          this._cachePositions(),
          (this.s.lastInsert = d);
      this._shiftScroll(c);
    },
    _mouseUp: function(c) {
        ...
        if (e.c.update) {
          ...
          for (f = q.length; k < f; k++) {
            ...
            b.columns().every(function() {
              this.dataSrc() === g &&
                b.cell(q[k].node, this.index()).invalidate("data");
            });
          }
      ...
      this.c.editor
        ? ((this.c.enable = !1),
          this.c.editor
            .edit(p, !1, a.extend({ submit: "changed" }, this.c.formOptions))
            .multiSet(g, m)
    ...
    _shiftScroll: function(a) {
      var c = this,
        b = this.s.scroll,
        f = !1,
        g = a.pageY - d.body.scrollTop,
        h,
        l;
      65 > g ? (h = -5) : g > b.windowHeight - 65 && (h = 5);
      null !== b.dtTop && a.pageY < b.dtTop + 65
        ? (l = -5)
        : null !== b.dtTop && a.pageY > b.dtTop + b.dtHeight - 65 && (l = 5);
      h || l
        ? ((b.windowVert = h), (b.dtVert = l), (f = !0))
  ...
  a(d).on("init.dt.dtr", function(c, d, b) {
    "dt" === c.namespace &&
      ((c = d.oInit.rowReorder), (b = g.defaults.rowReorder), c || b) &&
      ((b = a.extend({}, c, b)), !1 !== c && new m(d, b));
  });
  return m;
});
